...
class PastSubmissions extends StatelessWidget {
  ...
  lstView(List<SubmitInfo> drbs) => ListView.builder(
      scrollDirection: Axis.vertical,
      shrinkWrap: true,
      itemCount: drbs.length,
        ...
        return Padding(
          ...
          child: ListTile(
            ...
            title: Row(
              ...
              children: [
                SizedBox.shrink(),
                Text(drbs[index].location,
                    style: const TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 22.0,
                        color: Color.fromARGB(255, 83, 120, 139))),
                Text(DateFormat('M/d/yy').format(drbs[index].submitDate!),
                    style: const TextStyle(
                        fontWeight: FontWeight.w500,
                        fontSize: 20.0,
                        color: Color.fromARGB(255, 83, 120, 139))),
            ...
            subtitle: Text(drbs[index].lotNum.toString()),
            trailing: IconButton(
                icon: const Icon(Icons.arrow_forward),
                onPressed: () async {
                  await subProv.viewSubmission(drbs[index]);
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => DrbView()));
                }),
          ),
        );
      });
          ...
          body: subCon.getDrbs.isEmpty || subCon.getLots.isEmpty
              ...
              : Column(
                  children: [
                    ...
                    Expanded(child: lstView(subCon.getDrbs)),
                  ],
                ));
    });
  }
